package com.ayi.curso.rest.serv.ayispringrestful.constants;

public class Exceptions {
    public static final String EXCEPTION_DATA_NULL = "The data no exist";
    ...
    public static final String EXCEPTION_FIEL_REQ = "Los campos son requeridos";
